...
class PaymentCreate(BaseModel):
    ...
    reference: constr(min_length=1) = Field(
        ...
        description="The reference returned by Paystack after initiating payment",
    )
...
class PaymentInDB(BaseModel):
    ...
    amount: float = Field(
        ...
        ge=0,
        title="Amount",
        description="The amount of the payment (non-negative)",
    )
    ...
    paystack_reference: constr(min_length=1) = Field(
        ...,
        title="Paystack Reference",
        description="The reference returned by Paystack",
    )
...
class PaymentUpdate(BaseModel):
    ...
    amount: Optional[float] = Field(
        ...
        ge=0,
        title="Amount",
        description="Amount involved in the payment (non-negative)",
    )
